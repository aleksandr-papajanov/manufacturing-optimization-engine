...
namespace ManufacturingOptimization.Gateway.Data.Mappings;
...
public class EntityMappingProfile : Profile
{
    public EntityMappingProfile()
    {
        ...
        CreateMap<OptimizationMetrics, OptimizationMetricsEntity>()
            ...
            .ForMember(dest => dest.SolverStatus, opt => opt.MapFrom(src => src.SolverStatus))
            .ForMember(dest => dest.ObjectiveValue, opt => opt.MapFrom(src => src.ObjectiveValue))
            .ForMember(dest => dest.StrategyId, opt => opt.Ignore())
            .ForMember(dest => dest.Strategy, opt => opt.Ignore());
